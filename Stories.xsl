...
<div class="jumbotron text-center" style="background-image: url(https://cdn.wallpapersafari.com/96/12/2C4yoJ.jpg)">
  <h1><font color="white">Stories</font></h1>
</div>
...
<div class="container">
  <div class="row">
    ...
    <xsl:apply-templates select="//CoffeePlace[placeName='Stories']"/>
    <h2>Grade</h2>
    <h5><xsl:value-of select="round((sum(//Grade[placeName='Stories']/uniqueAvGrade) div count(//Grade[placeName='Stories']/uniqueAvGrade)) * 10) div 10" /><br/></h5>
   (<xsl:value-of select="count(//Grade[placeName='Stories']/uniqueAvGrade)" /> votes)
  </div>
...
<div class="col-sm-5">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="stories.jpg" alt="Los Angeles"/>
    </div>
...
<xsl:apply-templates select="//signedin"/>
  ...
  <h1>Grades</h1>
<xsl:apply-templates select="//Grade[placeName='Stories']"/>
...
<xsl:template match="signedin">
    ...
    <div class="wrapper">
      ...
      <div>
        <b> Have you had a coffee at Stories? Grade it!</b>
        ...
        <label for="placeName"><b>Place Name: </b>Stories</label>
        <input name="placeName" value="Stories" id="placeName" readonly="true"></input>
      </div>
...
<xsl:template match="//Grade[placeName='Stories']">

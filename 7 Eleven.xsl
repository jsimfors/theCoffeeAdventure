...
<div class="jumbotron text-center" style="background-image: url(https://cdn.wallpapersafari.com/96/12/2C4yoJ.jpg)">
  <h1><font color="white">7 Eleven</font></h1>
</div>
...
<div class="container">
  <div class="row">
    ...
    <xsl:apply-templates select="//CoffeePlace[placeName='7 Eleven']"/>
    <h2>Grade</h2>
    <h5><xsl:value-of select="round((sum(//Grade[placeName='7 Eleven']/uniqueAvGrade) div count(//Grade[placeName='7 Eleven']/uniqueAvGrade)) * 10) div 10" /><br/></h5>
   (<xsl:value-of select="count(//Grade[placeName='7 Eleven']/uniqueAvGrade)" /> votes)
  </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="7eleven.jpg" alt="Los Angeles"/>
    </div>
...
<xsl:apply-templates select="//signedin"/>
  ...
  <h1>Grades</h1>
<xsl:apply-templates select="//Grade[placeName='7 Eleven']"/>
...
<xsl:template match="signedin">
    ...
    <div class="wrapper">
      ...
      <div>
        <b> Have you had a coffee at 7 Eleven? Grade it!</b>
        ...
        <label for="placeName"><b>Place Name: </b>7 Eleven</label>
        <input name="placeName" value="7 Eleven" id="placeName" readonly="true"></input>
      </div>
...
<xsl:template match="//Grade[placeName='7 Eleven']">

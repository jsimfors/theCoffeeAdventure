...
<div class="jumbotron text-center" style="background-image: url(https://cdn.wallpapersafari.com/96/12/2C4yoJ.jpg)">
  <h1><font color="white">THS Cafe</font></h1>
</div>
...
<div class="container">
  <div class="row">
    ...
    <xsl:apply-templates select="//CoffeePlace[placeName='THS Cafe']"/>
    <h2>Grade</h2>
    <h5><xsl:value-of select="round((sum(//Grade[placeName='THS Cafe']/uniqueAvGrade) div count(//Grade[placeName='THS Cafe']/uniqueAvGrade)) * 10) div 10" /><br/></h5>
   (<xsl:value-of select="count(//Grade[placeName='THS Cafe']/uniqueAvGrade)" /> votes)
  </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="thscafe.jpg" alt="Los Angeles"/>
    </div>
...
<xsl:apply-templates select="//signedin"/>
  ...
  <h1>Grades</h1>
<xsl:apply-templates select="//Grade[placeName='THS Cafe']"/>
...
<xsl:template match="signedin">
    ...
    <div class="wrapper">
      ...
      <div>
        <b> Have you had a coffee at THS Cafe? Grade it!</b>
        ...
        <label for="placeName"><b>Place Name: </b>THS Cafe</label>
        <input name="placeName" value="THS Cafe" id="placeName" readonly="true"></input>
      </div>
...
<xsl:template match="//Grade[placeName='THS Cafe']">

...
<div class="container">
  <div class="row">
    ...
    <xsl:apply-templates select="//CoffeePlace[placeName='Q']"/>
    <h2>Grade</h2>
    <h5><xsl:value-of select="round((sum(//Grade[placeName='Q']/uniqueAvGrade) div count(//Grade[placeName='Q']/uniqueAvGrade)) * 10) div 10" /><br/></h5>
   (<xsl:value-of select="count(//Grade[placeName='Q']/uniqueAvGrade)" /> votes)
  </div>
...
<xsl:apply-templates select="//signedin"/>
  ...
  <h1>Grades</h1>
<xsl:apply-templates select="//Grade[placeName='Q']"/>
...
<xsl:template match="signedin">
    ...
    <div class="wrapper">
      ...
      <div>
        <b> Have you had a coffee at Q? Grade it!</b>
        ...
        <label for="placeName"><b>Place Name: </b>Q</label>
        <input name="placeName" value="Q" id="placeName" readonly="true"></input>
      </div>
...
<xsl:template match="//Grade[placeName='Q']">

...
<div class="jumbotron text-center" style="background-image: url(https://cdn.wallpapersafari.com/96/12/2C4yoJ.jpg)">
  <h1><font color="white">KTH Entre</font></h1>
</div>
...
<div class="container">
  <div class="row">
    ...
    <xsl:apply-templates select="//CoffeePlace[placeName='KTH Entre']"/>
    <h2>Grade</h2>
    <h5><xsl:value-of select="round((sum(//Grade[placeName='KTH Entre']/uniqueAvGrade) div count(//Grade[placeName='KTH Entre']/uniqueAvGrade)) * 10) div 10" /><br/></h5>
   (<xsl:value-of select="count(//Grade[placeName='KTH Entre']/uniqueAvGrade)" /> votes)
  </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="kthentre.jpg" alt="Los Angeles"/>
    </div>
...
<xsl:apply-templates select="//signedin"/>
  ...
  <h1>Grades</h1>
<xsl:apply-templates select="//Grade[placeName='KTH Entre']"/>
...
<xsl:template match="signedin">
    ...
    <div class="wrapper">
      ...
      <div>
        <b> Have you had a coffee at KTH Entre? Grade it!</b>
        ...
        <label for="placeName"><b>Place Name: </b>KTH Entre</label>
        <input name="placeName" value="KTH Entre" id="placeName" readonly="true"></input>
      </div>
...
<xsl:template match="//Grade[placeName='KTH Entre']">

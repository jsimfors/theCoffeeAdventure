...
<div class="jumbotron text-center" style="background-image: url(https://cdn.wallpapersafari.com/96/12/2C4yoJ.jpg)">
  <h1><font color="white">META</font></h1>
</div>
...
<div class="container">
  <div class="row">
    ...
    <xsl:apply-templates select="//CoffeePlace[placeName='META']"/>
    <h2>Grade</h2>
    <h5><xsl:value-of select="round((sum(//Grade[placeName='META']/uniqueAvGrade) div count(//Grade[placeName='META']/uniqueAvGrade)) * 10) div 10" /><br/></h5>
   (<xsl:value-of select="count(//Grade[placeName='META']/uniqueAvGrade)" /> votes)
  </div>
...
<div id="myCarousel" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="item active">
      <img src="meta.jpg" alt="Los Angeles"/>
    </div>

    <div class="item">
      <img src="coffee3.jpg" alt="Chicago"/>
    </div>
...
<xsl:apply-templates select="//signedin"/>
  ...
  <h1>Grades</h1>
<xsl:apply-templates select="//Grade[placeName='META']"/>
...
<xsl:template match="signedin">
    ...
    <div class="wrapper">
      ...
      <div>
        <b> Have you had a coffee at META? Grade it!</b>
        ...
        <label for="placeName"><b>Place Name: </b>META</label>
        <input name="placeName" value="META" id="placeName" readonly="true"></input>
      </div>
...
<xsl:template match="//Grade[placeName='META']">
